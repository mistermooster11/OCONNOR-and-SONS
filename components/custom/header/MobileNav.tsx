...
export default function MobileNav({ isOpen, onClose }: MobileNavProps) {
  ...
  return (
    <>
      ...
      >
        {/* .mobile-navi__head */}
        <div className="relative px-[2.4rem] py-[1rem] flex items-center min-h-[54px] border-b border-[rgba(255,210,104,.3)]">
          <Link href="/" onClick={onClose} aria-label="O'Connor & Sons Electric">
            <img src="/logos/logo-long.svg" alt="O'Connor & Sons Electric logo" className="block h-[3.2rem]" />
          </Link>
          {/* .mobile-navi__close */}
          <button
            onClick={onClose}
        ...
        <div className="absolute top-[54px] left-0 right-0 bottom-0 overflow-auto px-[13%] py-[3rem] box-border">
          ...
          <div className="relative pt-12 before:content-[''] before:absolute before:w-screen before:left-1/2 before:top-0 before:-translate-x-1/2 before:border-t before:border-[rgba(255,210,104,.3)]">
        ...
        >
          {activeItem && (
            <>
              {/* .menu-back */}
              <div className="relative pb-[1.2rem] mb-8 after:content-[''] after:absolute after:left-1/2 after:bottom-0 after:w-screen after:-translate-x-1/2 after:border-b after:border-[rgba(255,210,104,.3)]">
                <button
              ...
              {/* nav-dropdown__left */}
              <div className="pt-8 pb-4 relative after:content-[''] after:absolute after:left-1/2 after:bottom-0 after:w-screen after:-translate-x-1/2 after:border-b after:border-[rgba(255,210,104,.3)]">
                {/* nav-dropdown__title */}
                <Link
