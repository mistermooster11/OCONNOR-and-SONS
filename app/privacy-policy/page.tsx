      ...
      <div ref={bodyRef} className={`content-block flex-module fadeIn wow${bodyVis}`}>
        <div className="inner inner--slim-1172">
          <div className={`content-entry fadeInUpS wow${bodyVis}`} style={{ animationDelay: "0.1s", maxWidth: "72rem" }}>
            ...
            <p>
              O'Connor & Sons Electric (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or &ldquo;us&rdquo;) operates this website
            ...
            <ul>
              ...
              <li>Call us directly at (650) 740-1121</li>
            ...
            <p>
              <strong>O'Connor & Sons Electric</strong><br />
              849 Clara Drive, Palo Alto, CA 94303<br />
              Phone: <a href="tel:6507401121">(650) 740-1121</a>
            </p>
